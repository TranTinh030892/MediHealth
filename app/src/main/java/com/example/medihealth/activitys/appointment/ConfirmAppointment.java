...
//        String relativePhone = appointmentDTO.getRelativePhoneNumber();
...
//                                        Appointment appointment = new Appointment(userModel,appointmentDTO.getBookDate(),appointmentDTO.getAppointmentDate(),
//                                                appointmentDTO.getSpecialist(),doctor,appointmentDTO.getTime(),appointmentDTO.getSymptom(),0);
//                                        FirebaseUtil.getAppointmentCollectionReference().add(appointment).addOnCompleteListener(task1 -> {
...
//            getRelativeModel(relativePhone);
...
//                            if (task.isSuccessful()){
//                                Relative relative = task.getResult().toObject(Relative.class);
//                                Query query = FirebaseUtil.allDoctorCollectionReference().whereEqualTo("doctorId",doctorId);
//                                query.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
//                                    @Override
//                                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
...
//                                                if (task.isSuccessful()){
//                                                    doctor = task.getResult().toObject(Doctor.class);
//                                                    Appointment appointment = new Appointment(relative,appointmentDTO.getBookDate(),appointmentDTO.getAppointmentDate(),
//                                                            appointmentDTO.getSpecialist(),doctor,appointmentDTO.getTime(),appointmentDTO.getSymptom(),0);
//                                                    FirebaseUtil.getAppointmentCollectionReference().add(appointment).addOnCompleteListener(task1 -> {
//                                                        if (task1.isSuccessful()){
//                                                            showDialogNotice(Gravity.BOTTOM);
